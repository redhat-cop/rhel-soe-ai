...
```
ansible-playbook ansible/site.yml --tags packages_remove --check --diff
```
...
```
ansible-playbook ansible/site.yml --tags packages_remove
```
...
both `ansible-playbook ansible/site.yml --tags packages_remove ...` and a full,
