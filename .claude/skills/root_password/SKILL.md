...
```
ansible-playbook ansible/site.yml --tags root_password --check --diff
```
...
```
ansible-playbook ansible/site.yml --tags root_password
```
...
both `ansible-playbook ansible/site.yml --tags root_password ...` and a full,
