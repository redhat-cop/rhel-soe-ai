...
```
ansible-playbook ansible/site.yml --tags system_hostname --check --diff
```
...
```
ansible-playbook ansible/site.yml --tags system_hostname
```
...
both `ansible-playbook ansible/site.yml --tags system_hostname ...` and a full,
