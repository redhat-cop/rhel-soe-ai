...
```
ansible-playbook ansible/site.yml --tags ipv6_setup --check --diff
```
...
```
ansible-playbook ansible/site.yml --tags ipv6_setup
```
...
both `ansible-playbook ansible/site.yml --tags ipv6_setup ...` and a full,
