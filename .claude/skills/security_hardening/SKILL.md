...
```
ansible-playbook ansible/site.yml --tags security_hardening --check --diff
```
...
```
ansible-playbook ansible/site.yml --tags security_hardening
```
...
both `ansible-playbook ansible/site.yml --tags security_hardening ...` and a full,
