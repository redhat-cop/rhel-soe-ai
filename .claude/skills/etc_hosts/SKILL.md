...
```
ansible-playbook ansible/site.yml --tags etc_hosts --check --diff
```
...
```
ansible-playbook ansible/site.yml --tags etc_hosts
```
...
both `ansible-playbook ansible/site.yml --tags etc_hosts ...` and a full,
