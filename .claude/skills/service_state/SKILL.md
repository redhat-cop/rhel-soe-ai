...
```
ansible-playbook ansible/site.yml --tags service_state --check --diff
```
...
```
ansible-playbook ansible/site.yml --tags service_state
```
...
both `ansible-playbook ansible/site.yml --tags service_state ...` and a full,
